...
\begin{align}
 \pr{X=i} =
    ...
    \end{cases}       
\end{align}
All the dice must show the same number
\begin{align}
...
\end{multline}
where i=1,2,3,4,5,6.\\
There are 6 faces on a cubical dice. Hence, for all the dice to show the same number
\begin{align}
...
Therefore, the probability that all the three dice have the same number of dots on the face showing up is 0.028.
